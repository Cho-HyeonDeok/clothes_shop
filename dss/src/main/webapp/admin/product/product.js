...
function go_save() 
{
   ...
   if (theForm.kind.value == '') {
      ...
      theForm.action = "DssServlet?command=admin_product_write";
      theForm.submit();
   }
}
...
{
   var theForm = document.frm;
   theForm.action = "DssServlet?command=admin_product_list";
   theForm.submit();
}
//projectList.jsp
function go_search() {
...
function go_detail(tpage, pseq) {
   ...
   theForm.action =  "DssServlet?command=admin_product_detail&tpage=" +
                     tpage+"&pseq="+pseq;
...
function go_wrt() {
   var theForm = document.frm;
   theForm.action = "DssServlet?command=admin_product_write_form";
   theForm.submit();
}
// **************** productDetail.jsp
function go_list(tpage) {
   ...
   theForm.action = "DssServlet?command=admin_product_list&tpage=" + tpage;
   theForm.submit();
}
// **************** productDetail.jsp
function go_mod(tpage, pseq) {
   ...
   theForm.action = "DssServlet?command=admin_product_update_form&tpage=" + 
                    tpage+"&pseq="+pseq;
   theForm.submit();
}
...
function go_mod_save(tpage, pseq) {
   ...
   if (theForm.kind.value == '') {
      ...
      if (confirm('수정하시겠습니까?')) {
         ...
         theForm.action = "DssServlet?command=admin_product_update";
         theForm.submit();
      }
   }
}
...
function go_mod_mov(tpage, pseq) {
   var theForm = document.frm;
   theForm.action = 'DssServlet?command=admin_product_detail&tpage=' + tpage + "&pseq=" + pseq;
   theForm.submit();
}