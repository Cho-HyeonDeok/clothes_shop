...
<link rel="stylesheet" href="dmin/css/admin.css">
		...
		<table>
			<tr>
				<td width="642">상품명 <input type="text" name="key"> <input
					...
					name="btn_total" value="전체보기 "
					onClick="location.href='DssServlet?command=admin_product_list'">
					<input class="btn" type="button" name="btn_write" value="상품등록"
					onClick="location.href='DssServlet?command=admin_product_write_form'">
				</td>
			</tr>
		</table>
