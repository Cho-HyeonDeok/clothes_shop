...
<body>
    <div class="qna_main">
        <div class="qna_title">
            <div class="qna_title_font">
                CS Center
            </div>
        </div>
        <div class="qna_sub">
            <div class="qna_sub_teltime">
                <div class="qna_sub_tel">
                    Tel. 1544-7199
                </div>
                <div class="qna_sub_time">
                    평일 9:00~18:00
                </div>
            </div>
            <div class="qna_sub_qnasubqna">
                <div class="qna_sub_qna">
                    1:1 Q&A
                </div>
                <div class="qna_sub_subqna">
                    질문 전 FAQ(자주 묻는 질문)을 먼저 확인해 주세요.
                </div>
            </div>
            <div class="qna_sub_faqsubfaq">
                <div class="qna_sub_faq">
                    FAQ
                </div>
                <div class="qna_sub_subfaq">
                    자주 묻는 질문
                </div>
            </div>
        </div>
        <div class="qna_main_container">
            <div class="qna_main_title">
                <div class="qna_main_title_font">
                    1:1 Q&A
                </div>
                <div>
                    <div>
                        <div class="li_div">
                            <li class="li_red">제품 사용, 오염, 전용 박스 손상, 라벨 제거, 사은품 및 부속 사용/분실 시, 교환/환불이 불가능 합니다.</li>
            ...
            <div class="qna_under_form">
                <div class="qba_under_inputbest_form">
                    <div class="qna_under_input_form">
                        <!--문의 작성-->
                        <div class="qna_under_input_title">
                            문의 작성
                        </div>
                        <div class="qna_under_input_subform">
                            <div class="qna_under_input_select_form">
                                ...
                                <div class="qna_under_input_select_buttonlist_form">
                                    ...
                                    <div class="qna_under_input_sixbutton_form">
                                        ...
                                        <div class="qna_under_input_sixbutton_top">
                                            <div class="form_radio_btn radio_male">
                                                <input id="radio-1" type="radio" name="product_service" value="product_service1" checked>
                                                <label for="radio-1">배송</label>
                                            </div>

                                            <div class="form_radio_btn">
                                                <input id="radio-2" type="radio" name="product_service" value="product_service2">
                                                <label for="radio-2">주문/결제</label>
                                            </div>

                                            <div class="form_radio_btn">
                                                <input id="radio-3" type="radio" name="product_service" value="product_service3">
                                                <label for="radio-3">취소/교환/환불</label>
                                            </div>
                                        </div>
                                        <div class="qna_under_input_sixbutton_bottom">
                                            <div class="form_radio_btn radio_male">
                                                <input id="radio-4" type="radio" name="product_service" value="product_service4" checked>
                                                <label for="radio-4">회원정보</label>
                                            </div>

                                            <div class="form_radio_btn">
                                                <input id="radio-5" type="radio" name="product_service" value="product_service5">
                                                <label for="radio-5">상품확인</label>
                                            </div>

                                            <div class="form_radio_btn">
                                                <input id="radio-6" type="radio" name="product_service" value="product_service6">
                                                <label for="radio-6">서비스</label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="qna_under_input_list_form">
                                        <!--문의 유형 리스트-->
                                        <select class="qna_under_input_list" name="subject">
                                            <option value="0">문의 유형을 선택해 주세요</option>
                            ...
                            <div class="qna_under_input_text_form">
                                ...
                                <div class="qna_under_input_text_titlebox">
                                    <!--타이틀과 텍스트 상자-->
                                    <div class="qna_under_input_textbox_font">
                                        문의 내용
                                    </div>
                                    <div>
                                        <textarea style="border-color: #999;" cols="45" rows="10" name="content"
                            ...
                            <div class="qna_under_input_image_form">
                                ...
                                <div class="qna_under_input_image_main">
                                    <div class="qna_under_input_image_title">
                                        사진
                                    </div>
                                    <div>
                                        <input type="file" >
                    ...
                    <div class="qna_under_best_form">
                        <!--Best FAQ-->
                        <div class="qna_under_best_title">
                            Best FAQ
                        </div>
                        <div>
                            FAQ 넣기
                ...
                <div class="qna_under_button_form">
                    <div class="qna_under_button_box">
                        <div class="qna_user_button1">
                            취소
                        </div>
                        <div class="qna_user_button2">
                        	<button type="submit"> 작성하기</button>
                         <!-- <a href="DssServlet?command=qna_write"> </a>-->
                        </div>
                    </div>
                </div>
            </div>
