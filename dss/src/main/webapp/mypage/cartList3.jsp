			...
			<div class="mypage_Cart" style="width: 90%;">
				...
				<div class="mypage_CartSub">
					<div id="mypage_D">
								...
								<table class="mypage_Dt">
									<thead>
										<tr>
											...
											<th class="mypage_Col">주문일</th>
											<th class="mypage_Col">선택</th>
											<th>&nbsp;</th>
										</tr>
									</thead>
									<tbody>
						...
						<div class="mypage_Button" style="display: flex; align-items: center;justify-content: center;margin-top: 2%" >
							<div class="mypage_ButtonLeft">

								<div class="mypage_btn1" onclick="go_cart_delete()">선택 삭제</div>
							</div>
							<div>
							<div class="mypage_btn2"
								onclick="location.href='DssServlet?command=order_insert'">결제하기</div>
								</div>
						</div>
					</div>
				</div>
